...
class Results(SimpleClass):
    ...
    def save_crop(self, save_dir, file_name=Path("im.jpg")):
        ...
        """
        lpr=LPR()
        net = LPRNet(lpr_max_len=8, phase=False, class_num=len(self.CHARS), dropout_rate=0)
        net.load_state_dict(torch.load('lprnet_best.pth', map_location=torch.device('cpu')))
        ...
        for d in self.boxes:
            ...
            result = lpr.plates_recognize(net, img)
            # print(result)
